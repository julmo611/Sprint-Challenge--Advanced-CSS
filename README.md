...
Responsive :  Content based breakpoint
Adaptive: The creation different pages in accordance with the specific size of a device.


2. Describe what it means to be mobile first vs desktop first.
    Focused  that begins with designing for mobile users

3. What does `font-size: 62.5%` in the `html` tag do for us when using `rem` units?
    Conversion for easy math using rem units 1rem = 10px
